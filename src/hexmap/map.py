...
class Map(object):
    ...
    def ascii(self, numbers=True):
        ...
        if numbers:
            text_length = len(
                '{0},{1}'.format(str(self.rows - 1 if self.cols % 2 == 1 else self.rows),
    ...
    def neighbors(self, center):
        ...
        """
        result = list(filter(self.valid_cell, [
    ...
    def spread(self, center, radius=1):
        ...
        """
        result = {center}  # Start out with this center cell
        ...
        result = list(filter(self.valid_cell, result))  # filter invalid cells before returning.
        return result
    ...
    def cone(self, origin, direction, length=1):
        ...
        result = list(filter(self.valid_cell, set(result)))
        return result
    ...
    def slice(self, origin, direction, length=2):
        ...
        for i in range(1, length + 1):
            ...
            for j in range(i + 1):
                ...
                result.append(pos)
        result = list(filter(self.valid_cell, result))
        return result
    ...
    def line(self, origin, direction, length=3):
        ...
        results = list(filter(self.valid_cell, results))
        return results
    ...
    def cells(self):
        ...
        cells = list(filter(self.valid_cell, cells))
        return cells
...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', '--numbers', action="store_true", dest="numbers", default=False,
